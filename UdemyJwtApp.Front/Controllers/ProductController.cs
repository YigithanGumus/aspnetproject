    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> List()
        {
            ...
            if (token != null)
            {
                ...
                var response = await client.GetAsync("http://localhost:5060/api/products");
        ...
        public async Task<IActionResult> Remove(int id)
        {
            ...
            if (token != null)
            {
                ...
                await client.DeleteAsync($"http://localhost:5060/api/products/{id}");
        ...
        public async Task<IActionResult> Create()
        {
            ...
            if (token != null)
            {
                ...
                var response = await client.GetAsync($"http://localhost:5060/api/categories");
                ...
                if (response.IsSuccessStatusCode)
                {
                   ...
                   var data= JsonSerializer.Deserialize<List<CategoryListModel>>(jsonData, new JsonSerializerOptions
                    ...
                    model.Categories=new Microsoft.AspNetCore.Mvc.Rendering.SelectList(data,"Id","Definiton");
        ...
        public async Task<IActionResult> Create(CreateProductModel model)
        {
            ...
            if(ModelState.IsValid)
            {
                ...
                if (token != null)
                {
                    ...
                    var response = await client.PostAsync($"http://localhost:5060/api/products",content);
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            if (token != null)
            {
                ...
                var responseProduct = await client.GetAsync($"http://localhost:5060/api/products/{id}");
                ...
                if (responseProduct.IsSuccessStatusCode)
                {
                    ...
                    var responseCategory = await client.GetAsync($"http://localhost:5060/api/categories");
                    if (responseCategory.IsSuccessStatusCode)
                    {
                        ...
                        if (result!=null)
                            result.Categories = new Microsoft.AspNetCore.Mvc.Rendering.SelectList(data, "Id", "Definiton");
                    }
                    return View(result);
                }
            }
        ...
        public async Task<IActionResult> Update(UpdateProductModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (token != null)
                {
                    ...
                    var response = await client.PutAsync($"http://localhost:5060/api/products", content);
